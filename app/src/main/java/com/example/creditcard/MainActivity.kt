...
import com.example.creditcard.activity.AddActivity
import com.example.creditcard.adapter.CustomAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    fun saveOfflinePostsToServer() {
        val list = appDatabase.postDao().getOfflineCards()
    ...
    fun getCardsFromDatabase() {
        val list1 = appDatabase.postDao().getCards() as ArrayList<*>
        adapter = CustomAdapter(list1 as ArrayList<Card>)
